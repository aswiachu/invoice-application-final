...
import alexParker from './img/alex-parker.jpeg';
import jordanLee from './img/Jordan Lee.jpg'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faFileInvoice } from '@fortawesome/free-solid-svg-icons';
import { faUsers } from '@fortawesome/free-solid-svg-icons';
import { faDownload } from '@fortawesome/free-solid-svg-icons';
import { faListCheck } from '@fortawesome/free-solid-svg-icons';
import { faGift, faQuoteLeft, faPercent, faUserAlt, faCreditCard, faBell, faLock, faBuilding, faHeadset } from '@fortawesome/free-solid-svg-icons';
import './style.css';
        ...
        <div>
            ...
            <section className="container w-100">
                <div className="d-md-flex justify-content-center align-items-center text-center">
                    ...
                    <div className="container-child w-md-50">
                        ...
                        <Link to="/dashboard">
                            <button className="invoice-btn bg-primary text-white border-0 py-2 px-4 rounded my-3">
                                Start Invoicing
                            </button>
                        </Link>
                    </div>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 my-2 text-center">
                        <div className='d-flex justify-content-center align-items-center flex-column mx-3'>
                            <div className='bg-icon-circle bg-circle d-flex justify-content-center align-items-center my-3'>
            ...
            <section className="container features-sec py-4">
                ...
                <div className="row ">
                    <div className="col-md-6 my-3">
                        <div className='d-flex align-items-center justify-content-start'>
                            <div className='bg-small-circle bg-circle d-flex justify-content-center align-items-center me-3'>
                                <FontAwesomeIcon icon={faFileInvoice}  color='white' />
                            </div>
                ...
                <div className="row">
                    <div className="col-md-6 my-3">
                        <div className='d-flex align-items-center justify-content-start'>
                            <h3>Effortless Download</h3>
                            <div className='bg-small-circle bg-circle d-flex justify-content-center align-items-center ms-3'>
                                <FontAwesomeIcon icon={faDownload}  color='white' />
                            </div>
                        </div>
                ...
                <div className="row">
                    <div className="col-md-6 my-3">
                        <div className='d-flex align-items-center justify-content-start'>
                            <h3>GST Invoice</h3>
                            <div className='bg-small-circle bg-circle d-flex justify-content-center align-items-center ms-3'>
                                <FontAwesomeIcon icon={faPercent}  color='white' />
                            </div>
                        </div>
            ...
            <section className="bg-primary">
                <div className="container text-center py-5">
                    <div className="row justify-content-center align-items-center">
                        ...
                        <button className="btn bg-white my-4 sign-up w-md-25 w-75">Sign Up Now</button>
                    </div>
                </div>
            </section>
