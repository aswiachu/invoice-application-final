  ...
  return (
    <section className="vh-100 d-flex align-items-center justify-content-center p-2">
      <form className="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 border border-1 p-3 rounded shadow-lg" onSubmit={handleSubmit}>
        ...
        <div className="my-3 border border-1 border-secondary-subtle rounded px-3 py-1 border-dark d-flex align-items-center justify-content-center">
        ...
        <div className="text-center mt-4 mb-2">
          <button type="submit" className="btn btn-primary px-5 login w-100 fw-bold py-2" disabled={!isAgreed || !email || !password}>Login</button>
        </div>
